...
{
  if (query['budget'] == undefined || query['budget'] <= 0 || isNaN(query['budget']))  
    throw Error("Invalid value for budget");
  else if (query['mpg'] == undefined || query['mpg'] <= 0 || isNaN(query['mpg']))  
    throw Error("Invalid value for mpg");
  else if (query['fuelCost'] == undefined || query['fuelCost'] <= 0 || isNaN(query['fuelCost']))  
...
{
  if (query['distance'] == undefined || query['distance'] <= 0 || isNaN(query['distance']))  
